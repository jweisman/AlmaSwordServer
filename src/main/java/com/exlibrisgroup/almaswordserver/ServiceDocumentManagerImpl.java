...
import com.exlibrisgroup.almaswordserver.AlmaRepository.DepositProfile;
...
public class ServiceDocumentManagerImpl implements ServiceDocumentManager {
    ...
    public ServiceDocument getServiceDocument(String sdUri, AuthCredentials authCredentials, 
     	...
     	SwordUtilities.Authenticate(authCredentials, true);
    	AlmaRepository alma = new AlmaRepository(authCredentials);
    	List<DepositProfile> list = alma.getDepositProfiles();
        ...
        for (DepositProfile dp : list) {
            ...
            swordCollection.setAbstract(dp.getCollectionName());
